...
bundle exec ruby scraper.rb $(jq -r .reference.P4656 meta.json) |
  qsv select id,name,positionID,position,startDate,endDate,cabinet |
  qsv rename item,itemLabel,position,positionLabel,startDate,endDate,cabinet > scraped.csv
